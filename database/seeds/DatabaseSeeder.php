...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
     ...
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'LOCAL Audio test 1','duration' =>'00:00:45','poster_source' => 'testing/media/posters/4.png','category_id' => $c4->id, 'source' => 'testing/media/medias/1.mp3', 'type' => 'localAudio','description' => 'A automatic generated testaudio, streamed from https:
     $m1->tag('Audio');
     $m1->tag('Noisy');
     ...
     $m1->tag('Audio');
     $m1->tag('Test');
     $m1 = Media::create(['title' => 'Big bucks bunny test','duration' =>'00:00:30',"created_at" => "2017-08-17 03:21:52",'poster_source' => 'testing/media/posters/3.png','category_id' => $c1->id, 'source' => 'https:
     ...
     $m1->tag('35C3');
     $m1->tag('Doku');
     $m1 = Media::create(['title' => 'Freude ist nur ein Mangel an information',"created_at" => "2018-12-27 03:21:52",'poster_source' => 'testing/media/posters/6.png','category_id' => $c31->id, 'source' => 'https:
     $m1->tag('35C3');
     $m1->tag('Doku');
