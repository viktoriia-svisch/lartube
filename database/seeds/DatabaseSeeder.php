...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
     ...
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'LOCAL Audio test 1','poster_source' => 'testing/media/posters/4.png','category_id' => $c4->id, 'source' => 'testing/media/medias/1.mp3', 'type' => 'localAudio','description' => 'A automatic generated testaudio, streamed from https:
     $m1->tag('Audio');
     $m1->tag('Noisy');
     ...
     $m1->tag('Torrent');
     $m1->tag('Movie');
     $m1 = Media::create(['title' => 'Hackerethik - eine Einführung','poster_source' => 'testing/media/posters/6.png','category_id' => $c31->id, 'source' => 'https:
     $m1->tag('35C3');
     $m1->tag('Doku');
     $m1 = Media::create(['title' => 'Freude ist nur ein Mangel an information','poster_source' => 'testing/media/posters/6.png','category_id' => $c31->id, 'source' => 'https:
     $m1->tag('35C3');
     $m1->tag('Doku');
     ...
     $m1->tag('Movie');
     $m1->tag('Animation');
     $m1 = Media::create(['title' => 'ANOTHER Ocean test','category_id' => $c4->id,'poster_source' => 'testing/media/posters/1.png', 'source' => 'http:
     $m1->tag('Movie');
     $m1->tag('ZENCDN');
     $m1->tag('Some');
